...
abstract class UIColors {
  ...
  /// The color prymari COMER.
  static const Color orangeComer = Color(0xFFF85E11);

  /// The color prymari COMER.
  static const Color orangeComerLight = Color.fromRGBO(248, 94, 17, 227);

  /// The color prymari COMER.
  static const Color greenComer = Color(0xFF94BE2C);
